...
int main() {
    ...
    if (girls_number == 0) {printf("Sausage party");}
    else if ((girls_number + boys_number > 20) && (girls_number == boys_number)) {printf("The party is excellent!");}
    else if ((girls_number + boys_number > 20) && (girls_number != boys_number)) {printf("Quite cool party!");}
    else if (girls_number + boys_number < 20)                                    {printf("Average party...");}
